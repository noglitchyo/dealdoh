...
class EncryptionSystem
{
    ...
    public function encrypt(string $clientDnsWireQuery): DnsCryptQuery
    {
         ...
         */
        switch ($this->certificate->getEsVersion()) {
    ...
    private function decryptWithXsalsa20(string $response, string $keypair): string
    {
        ...
        $nonce               = substr($response, $resolverMagicLength, $respNonceLength);

        $encryptedQuery = substr($response, $resolverMagicLength + $respNonceLength);
