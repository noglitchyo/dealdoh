...
class DohHttpMessageFactoryTest extends TestCase
{
    ...
    /**
     * @var \NoGlitchYo\Dealdoh\Factory\MessageFactoryInterface|MockInterface
     */
    ...
    {
        $this->dnsMessageFactoryMock = Mockery::mock(\NoGlitchYo\Dealdoh\Factory\MessageFactoryInterface::class);
